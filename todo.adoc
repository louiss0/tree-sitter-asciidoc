...
2. Do we need to capture malformed `{attr}` references explicitly (e.g., a dedicated `attribute_reference_error` node), or is falling back to plain text sufficient?
